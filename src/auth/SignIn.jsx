  ...
  return (
    <div className="w-full h-screen bg-black bg-opacity-50 flex items-center justify-center p-4">
      ...
      <div className="bg-white rounded-2xl relative max-w-4xl w-full flex shadow-2xl overflow-hidden">
        ...
        <div className="hidden md:block absolute top-[-65px] left-[-150px] w-[480px] h-[480px] overflow-hidden">
        ...
        <div className="flex-1 px-16 py-12 ml-[300px] relative">
          ...
          <form className="mt-6 space-y-5">
            ...
            <div className="flex items-center my-4">
              ...
              <span className="px-3 text-xs font-light font-poppins">OR</span>
              <div className="flex-1 border-t border-gray-400"></div>
            </div>

            {/* Create account */}
            <Link to="/signup">
              <button className="w-full h-12 border-2 border-black text-base font-semibold font-poppins rounded-lg text-black hover:bg-black hover:text-white transition-all">
                Create an Account
              </button>
            </Link>
          </form>
